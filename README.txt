...
It was done in 2-3 days work, with a lot of messy code (if I remeber correctly) so don't be mad :( Still hope most of the code is easy to read so you won't have problems with Croatian language (code comments).

TODO:
  -questions from web service (now hardcoded in db)!
  -have to be for all screen sizes!
  -other fixes and whatever new features!
  
Graphics for app done by Zoran Antolović (https://www.facebook.com/zoran.antolovic.33)
Have fun!
